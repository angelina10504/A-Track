...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    static final String ALARM_TIMEOUT_ACTION = "com.rdxindia.ihbl.routrack.ALARM_TIMEOUT";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ALARM_TIMEOUT_ACTION.equals(action)) {
            ...
            Intent serviceIntent = new Intent(context, com.rdxindia.ihbl.routrack.service.LocationTrackingService.class);
        ...
        if (!com.rdxindia.ihbl.routrack.service.LocationTrackingService.isRunning) {
